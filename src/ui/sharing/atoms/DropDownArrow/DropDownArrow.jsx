...
export default function DropDownArrow() {
  ...
  return (
    <div className={styles.icon({themes, theme, active})}>
     <svg width="auto" height="auto" viewBox="0 -4.5 20 20" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="currentColor">
        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
          <title>arrow_up [#337]</title>
          <g id="Page-1" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="Dribbble-Light-Preview" transform="translate(-260.000000, -6684.000000)" fill="currentColor">
